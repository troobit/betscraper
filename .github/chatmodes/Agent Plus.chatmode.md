---
description: "A custom prompt to get copilot to be a better coding agent."
tools:
  [
    "changes",
    "codebase",
...
Todo Lists are stored at the root of the codebase in a file named `todo.md`. If this file does not exist, you must create it.
